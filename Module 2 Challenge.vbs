Attribute VB_Name = "Module1"
 Sub stockAnalysis():
    ...
    ' loop all worksheets in the Excel workbook
    For Each ws In Worksheets
        ...
        ' loop through all of the worksheets
                ...
                If ws.Cells(row + 1, 1).Value <> ws.Cells(row, 1).Value Then
                   ...
                   Else
                    ...
                    End If
                        ...
                        ' Calculate the quarterly change (difference in last close - first open)
                    ...
                    total = 0
                    ' reset the value of the quart change
         ...
         ' update the summary table row
          ...
          ' display the ticker symbol for the greatest increase, greatest decrease and greatest total stock volumn
